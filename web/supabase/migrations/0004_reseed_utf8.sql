-- ============================================================
-- Reseed: the original 0003 data was corrupted by a PowerShell
-- clipboard step that read the file as Windows-1252. This wipes
-- the seeded content and re-inserts it with proper UTF-8.
-- ============================================================

-- Clear previously-seeded content (cascades to lessons + exercises)
DELETE FROM units WHERE level = 'A1' AND unit_number BETWEEN 1 AND 3;
